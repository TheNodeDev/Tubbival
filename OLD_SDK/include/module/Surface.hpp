...
public:
    ...
    using _DrawSetColor = int(__funccc*)(void* thisptr, int r, int g, int b, int a);
    using _DrawFilledRect = int(__funccc*)(void* thisptr, int x0, int y0, int x1, int y1);
    using _DrawLine = int(__funccc*)(void* thisptr, int x0, int y0, int x1, int y1);
    using _DrawSetTextFont = int(__funccc*)(void* thisptr, HFont font);
    using _DrawSetTextColor = int(__funccc*)(void* thisptr, Color color);
#ifdef _WIN32
    ...
    using _StartDrawing = int(__funccc*)(void* thisptr);
    using _FinishDrawing = int(__cdecl*)();

    using _DrawGetTextureId = int(__funccc*)(void* thisptr, char const* filename);
    using _DrawGetTextureFile = int(__funccc*)(void* thisptr, int id, char* filename, int maxlen);
    using _DrawSetTextureFile = int(__funccc*)(void* thisptr, int id, const char* filename, int hardwareFilter, bool forceReload);
    using _DrawSetTextureRGBA = int(__funccc*)(void* thisptr, int id, const unsigned char* rgba, int wide, int tall);
    using _DrawSetTexture = int(__funccc*)(void* thisptr, int id);
    using _DrawGetTextureSize = int(__funccc*)(void* thisptr, int id, int& wide, int& tall);
    using _DrawTexturedRect = int(__funccc*)(void* thisptr, int x0, int y0, int x1, int y1);
    using _IsTextureIDValid = int(__funccc*)(void* thisptr, int id);
    using _CreateNewTextureID = int(__funccc*)(void* thisptr, bool procedural);
